...
import { ListItemButton, ListItemText, Checkbox, Card, CardContent, Grid } from "@mui/material";
        ...
        <Grid key={todo.id}>
          <Card style={{marginTop:10}}>
            ...
            <ListItemButton component="a" href="#simple-list">
              <Checkbox style={{paddingLeft:0}} color="primary" onClick={(event) => {deleteTodo(todo.id)}}></Checkbox>
